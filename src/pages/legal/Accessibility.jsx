    ...
    >
      ...
      <Section title="מה בוצע באתר">
        <Bullets items={[
          ...
          'בכל עמוד יש תפריט נגישות (הכפתור בצד המסך, קיצור מקלדת Ctrl+U, או הקישור "תפריט נגישות" בתחתית העמוד). הוא כולל הגדלת טקסט, ניגודיות גבוהה ומצב כהה או בהיר, שינוי רוויה ושחור-לבן, הדגשת קישורים וכותרות, תמיכה בדיסלקציה, ריווח טקסט וגובה שורה, יישור טקסט, הסתרת תמונות, עצירת אנימציות, סמן גדול, מדריך ומסכת קריאה, והצגת תיאורים של כפתורים ותמונות. הבחירות נשמרות בדפדפן. התפריט הוא תוספת להנגשה שבקוד האתר, לא תחליף לה.',
        ]} />
      </Section>
