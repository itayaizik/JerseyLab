    ...
    >
      ...
      <Section title="מה בוצע באתר">
        <Bullets items={[
          ...
          'בכל עמוד יש תפריט נגישות (הכפתור בצד שמאל של המסך) להגדלת טקסט, ניגודיות גבוהה, גווני אפור, הדגשת קישורים וכותרות, גופן קריא, ריווח טקסט, עצירת אנימציות וסמן גדול. הבחירות נשמרות בדפדפן. התפריט הוא תוספת להנגשה שבקוד האתר, לא תחליף לה.',
        ]} />
      </Section>
