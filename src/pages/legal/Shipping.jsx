  ...
  return (
    ...
    >
      ...
      <Section title="מיסטרי בוקס">
        <p>
          במיסטרי בוקס החולצה נבחרת באקראיות מתוך הסגנון והמידה שבחרת, וזהו טיב המוצר
          שנרכש. איננו מגלים מראש איזו חולצה יצאה - היא נחשפת רק בפתיחת הבוקס. לאחר המשלוח
          חלה זכות הביטול הרגילה שפורטה לעיל.
        </p>
      </Section>
