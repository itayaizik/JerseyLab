  ...
  return (
    <ResponsiveContainer width="100%" height={260}>
      <PieChart>
        ...
        <Tooltip contentStyle={{ background: 'var(--brand-navy)', border: 'none', borderRadius: 4, color: '#fff' }} />
  ...
  return (
    <ResponsiveContainer width="100%" height={260}>
      <BarChart data={data} layout="vertical" margin={{ left: 10, right: 20 }}>
        ...
        <Tooltip contentStyle={{ background: 'var(--brand-navy)', border: 'none', borderRadius: 4, color: '#fff' }} cursor={{ fill: 'rgba(232,98,42,0.1)' }} />
        <Bar dataKey="צפיות" fill="var(--brand-orange)" radius={[0, 4, 4, 0]} />
      </BarChart>
    </ResponsiveContainer>
  );
}