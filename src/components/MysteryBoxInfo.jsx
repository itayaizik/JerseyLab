...
export const MYSTERY_BOX_PANELS = [
  {
    ...
    paragraphs: [
      'חולצת כדורגל אקראית, בהפתעה. אתה קובע את המסגרת - סגנון, מידה, ומה לא להכניס - והחולצה יוצאת באקראיות מתוך מה שנשאר.',
      'זה לא מלאי עודף ולא חולצות פגומות. זו אותה איכות ואותו מחיר כמו כל חולצה באתר; ההבדל היחיד הוא שאתה לא יודע מה יצא.',
    ],
  },
  {
    icon: Check,
    ...
    items: [
      ...
      'הקבוצה, העונה והדגם יוצאים אקראית - זה מה שהופך את זה למיסטרי.',
      'אפשר להוסיף שרוול ארוך או מכנס קצר תואם, כמו בכל חולצה.',
  ...
  },
  {
    ...
    footnote: 'ככל שתפסול יותר, כך מצטמצם המאגר שממנו החולצה יוצאת - אם לא נשאר ממה להגריל, נחזור אליך לפני שנשלח משהו.',
  },
  {
    icon: ShieldCheck,
    title: 'אם לא אהבת',
  ...
  {
    icon: HelpCircle,
    title: 'למה מיסטרי בוקס?',
    paragraphs: [
      'בשביל ההפתעה. במקום לבחור חולצה מהקטלוג, אתה נותן לאקראיות להחליט - ואולי מקבל קבוצה או עונה שלא היית חושב עליהן בכלל. המחיר זהה לחולצה רגילה.',
    ],
  },
];
...
export const MYSTERY_BOX_HIGHLIGHTS = [
  'אתה בוחר סגנון ומידה - החולצה יוצאת אקראית',
