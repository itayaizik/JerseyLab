  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      {/* `end-3` rather than `right-4`: the site is RTL, and on an RTL page the
          ...
          target; 36px is a button someone can actually press on a phone. */}
      <DialogPrimitive.Close
        aria-label="סגירה"
        className="absolute end-3 top-3 flex h-9 w-9 items-center justify-center rounded-sm text-brand-navy/60 transition-colors hover:bg-brand-cream hover:text-brand-navy focus-visible:outline-none disabled:pointer-events-none">
        <X className="h-4 w-4" />
